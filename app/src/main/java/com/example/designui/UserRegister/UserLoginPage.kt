    ...
    fun UI() {
        Box(
            ...
            Column(modifier = Modifier.padding(top = 90.dp)) {
                ...
                IconButton(
                    onClick = {
                        val intent = Intent(this@UserLoginPage, MainActivity::class.java)
                    ...
                    Icon(
                        painter = painterResource(R.drawable.group52),
                        contentDescription = null,
                        modifier = Modifier
                            .fillMaxSize()
                ...
                TextButton(onClick = {
                    val intent = Intent(this@UserLoginPage, UserSignUpPage::class.java)
                    startActivity(intent)
                })
                {
                    Text(
